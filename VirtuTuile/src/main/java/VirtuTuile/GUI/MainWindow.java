...
public class MainWindow extends javax.swing.JFrame
{
    ...
    private boolean gridIsMagnetic = false;
     ...
     */
    private void movePointToGrid(Point point)
    {
        double gridDistance = canvasPanel.getGridDistance() * 10;
        
        int deltaX = (int) (point.x % gridDistance);
        int deltaY = (int) (point.y % gridDistance);
    ...
    private void canvasPanelMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_canvasPanelMouseMoved
        ...
        {
            if (gridIsMagnetic) movePointToGrid(metricPoint);
        ...
        switch (this.selectedMode)
        {
            ...
            case MOVE:
                ...
                if (selectedSurface != null)
                {
                    ...
                    originPoint = new Point(point.x - bounds.x, point.y - bounds.y);
                }
                break;
        }
    ...
    {
        if (gridIsMagnetic) movePointToGrid(point);
    ...
    {//GEN-HEADEREND:event_surfaceXFieldActionPerformed
        try
        {
            ...
            boolean status = controller.setRectangularSurfaceX(x, (RectangularSurface) selectedSurface);
    ...
    {//GEN-HEADEREND:event_surfaceYFieldActionPerformed
        try
        {
            ...
            boolean status = controller.setRectangularSurfaceY(y, (RectangularSurface) selectedSurface);
    ...
    {//GEN-HEADEREND:event_canvasPanelMouseDragged
        ...
        if (selectedMode == ApplicationModes.MOVE && selectedSurface != null)
        {
            ...
            int x = currentCursorPosition.x - originPoint.x;
            int y = currentCursorPosition.y - originPoint.y;
            Point newPos = new Point(x, y);
            if (gridIsMagnetic) movePointToGrid(newPos);
        ...
        else if (selectedMode == ApplicationModes.RECTANGLE && firstRectangleCorner != null)
        {
            Point point = pointToMetric(evt.getPoint());
            if (gridIsMagnetic) movePointToGrid(point);
            canvasPanel.setTemporaryRectangle(cornersToRectangle(firstRectangleCorner, point));
            canvasPanel.repaint();
        }
